...
export { patientController, PatientController } from './patient.controller';
export { doctorController, DoctorController, departmentController, DepartmentController } from './doctor.controller';
